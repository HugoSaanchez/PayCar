...
public interface DatosVehiculosService {
	...
	public Map<String, Object> getAlquiladoByMarcaAnioModeloAndVersion(String marca, int anio, String modelo,
			String version);

	public boolean alquilarVehiculo(String marca, int anio, String modelo, String version, String fechaInicio,
	...
	public Map<String, Object> obtenerDatosFiltrados(String email, List<String> marcas, String consumo, String ordenar,
			List<String> usuarios, String fechaInicio, String fechaFin);

	ResponseEntity<String> alquilarVehiculo(String marca, int anio, String modelo, String version, String fechaInicio,
			String fechaFin, String username);
	
	ResponseEntity<List<Map<String, Object>>> obtenerVehiculosAlquilados(String username);
}